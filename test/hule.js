...
suite("Majiang.Util", () => {
  suite("hule_mianzi(shoupai, rongpai)", () => {
    test("一般手(ツモ和了)", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(
          Majiang.Shoupai.fromString("m123p055s789z11122"),
          null
        ),
    ...
    test("一般手(ロン和了)", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(
          Majiang.Shoupai.fromString("m123p055s789z1112"),
          "z2+"
        ),
    ...
    test("一般手(副露あり)", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(
          Majiang.Shoupai.fromString("m123p055z1112,s7-89"),
          "z2="
        ),
    ...
    test("七対子形", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(
          Majiang.Shoupai.fromString("m225p4466s1199z33"),
          "m0-"
        ),
    ...
    test("国士無双形(ツモ)", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(
          Majiang.Shoupai.fromString("m9p19s19z12345677m1"),
          null
        ),
        [
          [
    ...
    test("九蓮宝燈形", () =>
      assert.deepEqual(
        ...
        [["m55=!", "m111", "m234", "m678", "m999"], ["m11123456789995=!"]]
      ));
    test("和了形以外(少牌)", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(
    ...
    test("和了形以外(三面子)", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(
          Majiang.Shoupai.fromString("___m123p055z2,s7-89"),
          "z2="
        ),
        []
      ));
    test("和了形以外(一対子)", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(Majiang.Shoupai.fromString("m22")),
        []
      ));
    test("和了形以外(国士無双テンパイ)", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(
          Majiang.Shoupai.fromString("m19p19s19z123456"),
          "z7="
        ),
        []
      ));
    test("和了形以外(九蓮宝燈テンパイ)", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(
          Majiang.Shoupai.fromString("m111234567899"),
          "m9="
        ),
        []
      ));
    test("複数の和了形としない(順子優先)", () =>
      assert.deepEqual(
        Majiang.Util.hule_mianzi(
          Majiang.Shoupai.fromString("m111123p789999z1z1"),
          null
        ),
    ...
    test("複数の和了形(九蓮宝燈形)", () =>
      assert.deepEqual(
        ...
        [["s99", "s111", "s2_!34", "s456", "s789"], ["s11134456789992_!"]]
      ));
  });
  ...
  suite("hule(shoupai, rongpai, param)", () => {
    ...
    test("和了形以外", () => {
      hule = Majiang.Util.hule(Majiang.Shoupai.fromString(), null, param());
      assert.ifError(hule);
    });
    ...
    test("和了役: 三槓子", () => {
      hule = Majiang.Util.hule(
        Majiang.Shoupai.fromString("p11m45,s2222+,m888=8,z4444"),
        "m3=",
        param()
      );
    ...
    test("和了役: 大四喜(パオ)", () => {
      hule = Majiang.Util.hule(
        Majiang.Shoupai.fromString("m2,z222+,z4444,z333+,z111-"),
        "m2=",
        param()
      );
      assert.deepEqual(hule.hupai, [
    ...
    test("和了役: 四槓子", () => {
      hule = Majiang.Util.hule(
        Majiang.Shoupai.fromString("m1,z5555,p222+2,p777-7,s1111-"),
        "m1=",
        param()
      );
    ...
    test("ドラ: 裏ドラなし", () => {
      hule = Majiang.Util.hule(
        Majiang.Shoupai.fromString("m344556s24678z66*"),
        "s3=",
        param({ lizhi: 1, baopai: ["s9"], fubaopai: ["s9"] })
      );
      assert.deepEqual(hule.hupai, [{ name: "立直", fanshu: 1 }]);
    });
    test("ドラ: 裏ドラ: 1", () => {
      hule = Majiang.Util.hule(
        Majiang.Shoupai.fromString("m344556s24678z66*"),
        "s3=",
        param({ lizhi: 1, baopai: ["s9"], fubaopai: ["m2"] })
      );
      assert.deepEqual(hule.hupai, [
        { name: "立直", fanshu: 1 },
        { name: "裏ドラ", fanshu: 1 },
    ...
    test("ドラ: ドラ: 1, 裏ドラ: 1", () => {
      hule = Majiang.Util.hule(
        Majiang.Shoupai.fromString("m344556s24678z66*"),
        "s3=",
        param({ lizhi: 1, baopai: ["m2"], fubaopai: ["m2"] })
      );
      assert.deepEqual(hule.hupai, [
        { name: "立直", fanshu: 1 },
        { name: "ドラ", fanshu: 1 },
    ...
    test("点計算: ダブル役満パオ 放銃者あり、関連役満のみ放銃者と折半", () => {
      hule = Majiang.Util.hule(
        Majiang.Shoupai.fromString("z7,z111-,z2222,z333=3,z444+"),
        "z7-",
        param({ lizhibang: 1, changbang: 1 })
      );
      assert.deepEqual(hule, {
    ...
    test("高点法: 役満と数え役満では役満を選択", () => {
      hule = Majiang.Util.hule(
        ...
        null,
        param({ lizhi: 1, yifa: true, baopai: ["m2"], fubaopai: ["m5"] })
      );
      assert.deepEqual(hule, {
    ...
    suite("数え役満なし", () => {
      test("13翻も3倍満とする", () => {
        hule = Majiang.Util.hule(
          Majiang.Shoupai.fromString("p22334455667788*"),
          null,
          param({ lizhi: 1, rule: Majiang.rule({ 数え役満あり: false }) })
        );
        assert.deepEqual(hule, {
          hupai: [
            { name: "立直", fanshu: 1 },
    ...
    suite("切り上げ満貫あり", () => {
      test("30符 3翻 親 ツモ → 2000∀ (切り上げなし)", () => {
        hule = Majiang.Util.hule(
          ...
          param({
            zhuangfeng: 1,
            menfeng: 0,
            rule: Majiang.rule({ 切り上げ満貫あり: true }),
          })
        );
        assert.deepEqual(hule, {
          hupai: [
      ...
      test("30符 4翻 子 ツモ → 2000/4000", () => {
        hule = Majiang.Util.hule(
          Majiang.Shoupai.fromString("m11z111p123789s789"),
          null,
          param({ rule: Majiang.rule({ 切り上げ満貫あり: true }) })
        );
        assert.deepEqual(hule, {
          hupai: [
            { name: "門前清自摸和", fanshu: 1 },
