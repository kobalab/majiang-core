...
suite("Majiang.Shoupai", () => {
  ...
  suite("static valid_pai(p)", () => {
    ...
    test("x     : 不正", () => assert.ifError(Majiang.Shoupai.valid_pai("x")));
    test("mm    : 不正", () => assert.ifError(Majiang.Shoupai.valid_pai("mm")));
    test("z0    : 不正", () => assert.ifError(Majiang.Shoupai.valid_pai("z0")));
    test("z8    : 不正", () => assert.ifError(Majiang.Shoupai.valid_pai("z8")));
    test("m9x   : 不正", () =>
  ...
  suite("static fromString(paistr)", () => {
    ...
    test("副露なしの場合にインスタンスが生成できること", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("z7654s987p654m321"),
        "m123p456s789z4567"
      ));
    test("副露ありの場合でもインスタンスが生成できること", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m1,p123-,s555=,z777+7,m9999"),
        "m1,p123-,s555=,z777+7,m9999"
      ));
    test("伏せ牌がある場合でもインスタンスが生成できること", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789____"),
        "____m123p456s789"
      ));
    test("伏せ牌がある場合でもインスタンスが生成できること(副露あり)", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456____,s789-"),
        "____m123p456,s789-"
      ));
    test("少牌の場合でもインスタンスが生成できること", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m111p222s333"),
        "m111p222s333"
      ));
    test("多牌の場合、14枚としてからインスタンスを生成すること", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123456789p123456"),
        "m123456789p1234p5"
      ));
    test("多牌の場合、14枚としてからインスタンスを生成すること(副露あり)", () => {
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123456789p123,z111="),
        "m123456789p1p2,z111="
      );
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123,z111=,p123-,s555=,z777+"),
        "m1m2,z111=,p123-,s555=,z777+"
      );
    });
    test("ツモ牌を再現してインスタンスを生成すること", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m11123456789991"),
        "m1112345678999m1"
      ));
    test("ツモ牌を再現してインスタンスを生成すること(赤牌をツモ)", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m11123456789990"),
        "m1112345678999m0"
      ));
    test("ツモ牌を再現してインスタンスを生成すること(副露あり)", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m12p345s678z23m3,z111="),
        "m12p345s678z23m3,z111="
      ));
    test("手牌中の赤牌を再現してインスタンスを生成すること", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m5550p5500s0000z00"),
        "m0555p0055s0000"
      ));
    test("リーチを再現してインスタンスを生成すること", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z1112*"),
        "m123p456s789z1112*"
      ));
    test("リーチを再現してインスタンスを生成すること(暗槓あり)", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2*,z1111"),
    ...
    test("副露面子を正規化してインスタンスを生成すること(チー)", () => {
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,m403-"),
        "m123p456s789z2,m3-40"
      );
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,m304-"),
        "m123p456s789z2,m34-0"
      );
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,m345-"),
        "m123p456s789z2,m345-"
      );
    });
    test("副露面子を正規化してインスタンスを生成すること(ポン)", () => {
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,p050+"),
        "m123p456s789z2,p500+"
      );
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,p055+"),
        "m123p456s789z2,p505+"
      );
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,p550+"),
        "m123p456s789z2,p550+"
      );
    });
    test("副露面子を正規化してインスタンスを生成すること(カン)", () => {
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,s0555="),
        "m123p456s789z2,s5505="
      );
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,s0050="),
        "m123p456s789z2,s5000="
      );
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,s0505"),
        "m123p456s789z2,s5500"
      );
    });
    test("不正な副露面子を無視してインスタンスを生成すること(不正な牌)", () => {
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,z000+"),
        "m123p456s789z2"
      );
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,z888+"),
        "m123p456s789z2"
      );
    });
    test("不正な副露面子を無視してインスタンスを生成すること(字牌でのチー)", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,z1-23"),
        "m123p456s789z2"
      ));
    test("不正な副露面子を無視してインスタンスを生成すること(下家からのチー)", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,s1+23"),
        "m123p456s789z2"
      ));
    test("不正な副露面子を無視してインスタンスを生成すること(対子)", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,z11-"),
        "m123p456s789z2"
      ));
    test("不正な副露面子を無視してインスタンスを生成すること(両嵌)", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,s13-5"),
        "m123p456s789z2"
      ));
    test("不正な副露面子を無視してインスタンスを生成すること(連子)", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("m123p456s789z2,m1p2s3-"),
        "m123p456s789z2"
      ));
    test("副露直後の手牌を再現してインスタンスを生成すること", () =>
      assert.equal(
        "" + Majiang.Shoupai.fromString("p456s789z1,m12-3,p999=,"),
  ...
  suite("fromString(paistr)", () => {
    test("牌姿から手牌を更新できること", () =>
      assert.equal(
        "" + new Shoupai().fromString("m123p456s789z1122z2"),
        "m123p456s789z1122z2"
      ));
    test("副露あり", () =>
      assert.equal(
        "" + new Shoupai().fromString("m123p456s789z2,z111="),
        "m123p456s789z2,z111="
      ));
    test("リーチ後", () =>
      assert.equal(
        "" + new Shoupai().fromString("m123p456s789z1122*"),
        "m123p456s789z1122*"
      ));
    test("伏せ牌あり", () =>
      assert.equal(
        "" + new Shoupai().fromString("__________,z111="),
        "__________,z111="
      ));
  });
  ...
  suite("zumo(p)", () => {
    test("萬子をツモれること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z4567").zimo("m1"),
        "m123p456s789z4567m1"
      ));
    test("筒子をツモれること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z4567").zimo("p1"),
        "m123p456s789z4567p1"
      ));
    test("索子をツモれること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z4567").zimo("s1"),
        "m123p456s789z4567s1"
      ));
    test("字牌をツモれること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z4567").zimo("z1"),
        "m123p456s789z4567z1"
      ));
    test("赤牌をツモれること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z4567").zimo("m0"),
        "m123p456s789z4567m0"
      ));
    test("伏せ牌をツモれること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z4567").zimo("_"),
        "m123p456s789z4567_"
      ));
    test("不正な牌はツモれないこと", () => {
    ...
    test("多牌となる牌をツモることもできること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z34567").zimo("m1", false),
  ...
  suite("dapai(p, check = true)", () => {
    test("萬子を打牌できること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z34567").dapai("m1"),
        "m23p456s789z34567"
      ));
    test("筒子を打牌できること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z34567").dapai("p4"),
        "m123p56s789z34567"
      ));
    test("索子を打牌できること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z34567").dapai("s7"),
        "m123p456s89z34567"
      ));
    test("字牌を打牌できること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z34567").dapai("z3"),
        "m123p456s789z4567"
      ));
    test("赤牌を打牌できること", () =>
      assert.equal(
        "" + Shoupai("m123p406s789z34567").dapai("p0"),
        "m123p46s789z34567"
      ));
    test("リーチできること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z34567").dapai("z7*"),
        "m123p456s789z3456*"
      ));
    test("リーチ後にもツモ切り以外の打牌ができること(チェックしない)", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z11223*").dapai("z1"),
        "m123p456s789z1223*"
      ));
    test("伏せ牌がある場合、任意の牌が打牌できること", () =>
      assert.equal(
        "" + Shoupai("______________").dapai("m1"),
        "_____________"
      ));
    test("不正な牌は打牌できないこと", () => {
    ...
    test("少牌となる牌を打牌することもできること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z4567").dapai("m1", false),
        "m23p456s789z4567"
      ));
  ...
  suite("fulou(m, check = true)", () => {
    test("萬子を副露できること", () =>
      assert.equal(
        "" + Shoupai("m23p456s789z34567").fulou("m1-23"),
        "p456s789z34567,m1-23,"
      ));
    test("筒子を副露できること", () =>
      assert.equal(
        "" + Shoupai("m123p46s789z34567").fulou("p45-6"),
        "m123s789z34567,p45-6,"
      ));
    test("索子を副露できること", () =>
      assert.equal(
        "" + Shoupai("m123p456s99z34567").fulou("s999+"),
        "m123p456z34567,s999+,"
      ));
    test("字牌を副露できること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z1167").fulou("z111="),
        "m123p456s789z67,z111=,"
      ));
    test("赤牌を副露できること", () =>
      assert.equal(
        "" + Shoupai("m123p500s789z4567").fulou("p5005-"),
        "m123s789z4567,p5005-"
      ));
    test("リーチ後にも副露できること(チェックしない)", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z4567*").fulou("m1-23"),
        "m1p456s789z4567*,m1-23,"
      ));
    test("伏せ牌がある場合、それを使って副露できること", () =>
      assert.equal(
        "" + Shoupai("_____________").fulou("m1-23"),
        "___________,m1-23,"
      ));
    test("不正な面子で副露できないこと", () => {
    ...
    test("多牌となる副露もできること", () => {
      assert.equal(
        "" + Shoupai("m123p456s789z11567").fulou("z111=", false),
        "m123p456s789z567,z111=,"
      );
      assert.equal(
        "" + Shoupai("m123p456s789z22,z111=,").fulou("z222=", false),
  ...
  suite("gang(p, check = true)", () => {
    test("萬子で暗槓できること", () =>
      assert.equal(
        "" + Shoupai("m1111p456s789z4567").gang("m1111"),
        "p456s789z4567,m1111"
      ));
    test("萬子で加槓できること", () =>
      assert.equal(
        "" + Shoupai("m1p456s789z4567,m111+").gang("m111+1"),
        "p456s789z4567,m111+1"
      ));
    test("筒子で暗槓できること", () =>
      assert.equal(
        "" + Shoupai("m123p5555s789z4567").gang("p5555"),
        "m123s789z4567,p5555"
      ));
    test("筒子で加槓できること", () =>
      assert.equal(
        "" + Shoupai("m123p5s789z4567,p555=").gang("p555=5"),
        "m123s789z4567,p555=5"
      ));
    test("索子で暗槓できること", () =>
      assert.equal(
        "" + Shoupai("m123p456s9999z4567").gang("s9999"),
        "m123p456z4567,s9999"
      ));
    test("索子で加槓できること", () =>
      assert.equal(
        "" + Shoupai("m123p456s9z4567,s999-").gang("s999-9"),
        "m123p456z4567,s999-9"
      ));
    test("字牌で暗槓できること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z67777").gang("z7777"),
        "m123p456s789z6,z7777"
      ));
    test("字牌で加槓できること", () =>
      assert.equal(
        "" + Shoupai("m123p456s789z67,z777+").gang("z777+7"),
        "m123p456s789z6,z777+7"
      ));
    test("赤牌を含む暗槓ができること", () =>
      assert.equal(
        "" + Shoupai("m0055p456s789z4567").gang("m5500"),
        "p456s789z4567,m5500"
      ));
    test("赤牌を含む加槓ができること", () =>
      assert.equal(
        "" + Shoupai("m123p5s789z4567,p505=").gang("p505=5"),
        "m123s789z4567,p505=5"
      ));
    test("赤牌で加槓できること", () =>
      assert.equal(
        "" + Shoupai("m123p0s789z4567,p555=").gang("p555=0"),
    ...
    test("伏せ牌がある場合、それを使って暗槓できること", () =>
      assert.equal(
        "" + Shoupai("______________").gang("m5550"),
        "__________,m5550"
      ));
    test("伏せ牌がある場合、それを使って加槓できること", () =>
      assert.equal(
        "" + Shoupai("___________,m555=").gang("m555=0"),
        "__________,m555=0"
      ));
    test("順子で槓できないこと", () =>
    ...
    test("槓の直後に槓できないこと", () =>
      assert.throws(() =>
        Shoupai("m1111p4444s789z567").gang("m1111").gang("p4444")
      ));
    test("少牌となる槓もできること", () => {
      assert.equal(
        "" + Shoupai("m1111p456s789z456").gang("m1111", false),
        "p456s789z456,m1111"
      );
      assert.equal(
        "" + Shoupai("m1111s789z4567,p456-,").gang("m1111", false),
        "s789z4567,p456-,m1111"
      );
      assert.equal(
        "" +
          Shoupai("m1111p4444s789z567")
            .gang("m1111", false)
            .gang("p4444", false),
  ...
  suite("get_dapai(check = true)", () => {
    ...
    test("リーチ後はツモ切りしかできないこと", () =>
      assert.deepEqual(Shoupai("m123p456s789z1234m1*").get_dapai(), ["m1_"]));
  ...
  suite("get_chi_mianzi(p, check = true)", () => {
    test("ツモ直後と副露の直後にチーできないこと", () => {
      ...
      assert.ifError(Shoupai("m123p456s789z12,z333=,").get_chi_mianzi("m1-"));
    ...
    test("打牌選択できなくなる鳴き方を含めないこと", () => {
      assert.deepEqual(
        Shoupai("s6789,m123-,p456-,z111+").get_chi_mianzi("s6-"),
        []
      );
      assert.deepEqual(
        Shoupai("s6789,m123-,p456-,z111+").get_chi_mianzi("s9-"),
        []
      );
      assert.deepEqual(
        Shoupai("s7889,m123-,p456-,z111+").get_chi_mianzi("s8-"),
        []
      );
      assert.deepEqual(
        Shoupai("s7899,m123-,p456-,z111+").get_chi_mianzi("s9-"),
        []
      );
      assert.deepEqual(
        Shoupai("s7789,m123-,p456-,z111+").get_chi_mianzi("s7-"),
        []
      );
      assert.deepEqual(
        Shoupai("s6678999,m123-,p456-").get_chi_mianzi("s6-"),
        []
      );
    });
  ...
  suite("get_peng_mianzi(p)", () => {
    test("ツモ直後と副露の直後にポンできないこと", () => {
      assert.ifError(Shoupai("m112p456s789z12345").get_peng_mianzi("m1+"));
      assert.ifError(Shoupai("m112p456s789z12,z333=,").get_peng_mianzi("m1="));
    ...
    test("リーチ後はポンできないこと", () =>
      assert.deepEqual(
        Shoupai("m112p456s789z1234*").get_peng_mianzi("m1+"),
        []
      ));
    test("不正な牌でポンできないこと", () => {
  ...
  suite("get_gang_mianzi(p)", () => {
    test("ツモ直後と副露の直後に大明槓できないこと", () => {
      assert.ifError(Shoupai("m111p456s789z12345").get_gang_mianzi("m1+"));
      assert.ifError(Shoupai("m111p456s789z12,z333=,").get_gang_mianzi("m1+"));
      assert.ifError(Shoupai("______________").get_gang_mianzi("m1-"));
    });
    test("大明槓できるメンツがない場合", () => {
      assert.deepEqual(Shoupai("m123p456s789z1122").get_gang_mianzi("z1+"), []);
      assert.deepEqual(Shoupai("_____________").get_gang_mianzi("z1="), []);
    });
    test("下家から大明槓できること", () =>
    ...
    test("暗槓できるメンツがない場合", () => {
      ...
      assert.deepEqual(Shoupai("______________").get_gang_mianzi(), []);
    });
    test("萬子で暗槓できること", () =>
    ...
    test("リーチ後も暗槓できること", () =>
      assert.deepEqual(Shoupai("m111p456s789z1122m1*").get_gang_mianzi(), [
        "m1111",
      ]));
    test("リーチ後は送り槓できないこと", () =>
      assert.deepEqual(Shoupai("m111123p456s78z11m4*").get_gang_mianzi(), []));
    test("暗槓できるメンツが複数の場合", () =>
    ...
    test("打牌と副露の直後には加槓できないこと", () => {
      assert.ifError(Shoupai("m1p555s999z123,m111-").get_gang_mianzi());
      assert.ifError(Shoupai("m1p555s999,z333=,m111-").get_gang_mianzi());
      assert.ifError(Shoupai("m12p555s999,z333=,m111-,").get_gang_mianzi());
      assert.ifError(Shoupai("__________,m111-,").get_gang_mianzi());
    });
    test("加槓できるメンツがない場合", () => {
      assert.deepEqual(Shoupai("m123p456s789z12,z777+").get_gang_mianzi(), []);
      assert.deepEqual(Shoupai("___________,z777+").get_gang_mianzi(), []);
    });
    test("萬子で加槓できること", () =>
    ...
    test("リーチ後は加槓できないこと", () =>
      assert.deepEqual(
        Shoupai("p456s789z1234m1*,m111+").get_gang_mianzi(),
        []
      ));
    test("加槓できるメンツが複数の場合", () =>
