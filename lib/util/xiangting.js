...
export function xiangting_yiban(shoupai) {
...
export function xiangting_guoshi(shoupai) {
...
export function xiangting_qidui(shoupai) {
...
export function xiangting(shoupai) {
    return Math.min(
...
export function tingpai(shoupai, f_xiangting = xiangting) {
